...
% Everything below added by CII
  ...
  may occur for a number of reasons, the most likely of which is the
  ...
  The models are extremelly RAM intensive; particularly the individual
  ...
  sampling to sample a subset of my observations\footnote{A long term
    ...
    RStudio server, ar Amazon Work Spaces (AWS).}.
