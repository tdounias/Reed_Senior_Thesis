...
% Everything below added by CII
  ...
  be a national holiday? How about referenda? Should the people be
  ...
  elections policy. I provide an overview of current voting methods in the
  ...
  turnout, as they usually require no estimation. These counts can be
  extracted from voter registration files.\footnote{Not to say that this
    process does not involve significant data wrangling challenges.} Such
  a metric is only representative of the electoral political participation
  level of a group that has already taken a step towards participating, by
  registering to vote. Researchers should be careful to also include
  registration level by income, race, gender, or other metrics if using
  this form of turnout calculation to infer levels of participation by
  ...
  race. I will specify the model I will use for turnout in the fourth
  chapter.
  ...
  \item
    ...
    recipients and their voting patterns (2002). The conclusion from all
  ...
  {\centering \includegraphics[width=1\linewidth]{/Users/tdounias/Desktop/Reed_Senior_Thesis/maps/us_vbm_status} 
  ...
  mail voting should not have substantial effects, but those effects are
  ...
  {\centering \includegraphics[width=0.8\linewidth]{/Users/tdounias/Desktop/Reed_Senior_Thesis/plots/Spline_plot} 
  
  }
  
  \caption[Model 4 Turnout Coefficient for Time]{Model 4 Turnout Coefficient for Time}\label{fig:time splines}
  \end{figure}
