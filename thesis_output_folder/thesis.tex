...
% Everything below added by CII
  ...
  \caption[Estimated county level coefficients] {Estimated county level coefficients (**Significant
  at the .01 level *at the .05 level)
  \label{tab:model_county_coef}}\tabularnewline
  \toprule
  ...
  \caption[Estimated individual level coefficients] {Estimated individual level coefficients (**Significant
  at the .01 level *at the .05 level)
