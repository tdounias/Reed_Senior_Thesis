...
## Gibbs Sampler for County Models
...
As is obvious from Table A.1, the Gibbs sampler produces values very similar to the ones given by an \textit{R} call of Model 1.
