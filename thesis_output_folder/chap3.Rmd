...
$$y^{turnout~\%}_{c, l} \sim x^{mail~vote~\%}_{c, el}\beta_1 + \sum_{k = 1}^{4}w_{k, l}^{election~type}\beta_{k+1} + \sum_{j = 1}^{7}w_{j, l}^{election~year}\beta_{j+5} + \sum_{c = 1}^{64} x_c\beta_{c+13} + x^{white~\%}_{c}\beta_{78} + x^{urban~\%}_{c}\beta_{79}$$ 
...
$$y^{turnout~\%}_{c, l} \sim x^{mail~vote~\%}_{c, l}\beta_1 + \sum_{k = 1}^{4}w_{k, l}^{election~type}\beta_{k+1} + \sum_{j = 1}^{7}w_{j, l}^{election~year}\beta_{j+5} + \alpha_{[c]}$$ 
...
$$y^{turnout~\%}_{c, l} \sim x^{mail~vote~\%}_{c, l}\beta_1 + \sum_{k = 1}^{4}w_{k, l}^{election~type}\beta_{k+1} + \sum_{j = 1}^{7}w_{j, l}^{election~year}\beta_{j+5} + \sum_{c = 1}^{n} x^{county~classification}_c\beta_{c+13}$$ 
