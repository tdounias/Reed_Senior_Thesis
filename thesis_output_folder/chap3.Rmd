...
```{r white pct map, echo=FALSE, fig.cap="White voters per Colorado county", out.width = '60%', fig.align='center'}
...
|:---------|----------------:|---------------:|:---------------------------------|
|Adams     |          44,1603|            0.09|Denver-Aurora-Lakewood Metro Area |
|Arapahoe  |          572,003|            0.11|Denver-Aurora-Lakewood Metro Area |
|Boulder   |          294,567|            0.06|Boulder                           |
|Denver    |          600,158|            0.12|Denver                            |
|Douglas   |          285,465|            0.06|Denver-Aurora-Lakewood Metro Area |
|El Paso   |          622,263|            0.12|Colorado Springs                  |
|Jefferson |          534,543|            0.11|Denver-Aurora-Lakewood Metro Area |
|Larimer   |          299,630|            0.06|Fort COllins                      |
|Other     |        1,378,964|            0.27|                                  |
|Colorado  |        5,029,196|            1.00|                                  |


### The Politics of Colorado

Colorado is both a typical and non-typical froniter state.

### Voting in Colorado  
    
Each County individually administrates local, coordinated, primary, and general elections, under the supervision of the Colorado Secretary of State. This means that each county individually handles the voters registered in that county. Unsurprisingly, the same eight most populous counties are also the counties with the majority of registered voters, as their registrants comprise 73% of total Colorado registered voters (as of November 2017). As the following table shows, these eight counties have a registration rate between 60-80%, compared to a Colorado-wide rate of about 67%. Registration rates for all counties are also graphically depicted in figure 3.2. In terms of Party registration, Colorado as a whole leans democratic by a very narrow margin(figure 3.3). 
    
 County    | Total Registered Voters|County Voter Registration Rate | % of Statewide Registrants|
|:---------|-----------------------:|:------------------------------|--------------------------:|
|Adams     |                 27,0303|0.61                           |                       0.07|
...
```{r reg per county map, echo=FALSE, fig.cap="Registration rates per Colorado county", out.width = '60%', fig.align='center'}
knitr::include_graphics("/Users/tdounias/Desktop/Reed_Senior_Thesis/maps/pct_registered_county_map.png")
```

```{r party reg per county map, echo=FALSE, fig.cap="Democratic/Republican party lean per Colorado county", out.width = '60%', fig.align='center'}
