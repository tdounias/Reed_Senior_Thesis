...
% Everything below added by CII
  ...
  of \emph{find}, median household income of \emph{find}, and poverty rate
  of \emph{find}. Colorado's population is mostly white (\emph{find}),
  with a higher minority group population density in its Southern regions,
  as shown on Map (\emph{insert racial demographics map}). These
  statistics, along with national averages, are also presented in table
  \emph{make and insert a table}.
  ...
  (as of November 2017). As Table (\emph{insert table}) shows, these eight
  ...
  are also graphically depicted in map (\emph{insert map here}). In terms
  of Party registration, Colorado as a whole leans democratic by a very
  narrow margin. This is also reflected in the state's Cook Partisan
  Voting Index of D +1, making it a solidly purple battleground state
  (\emph{also insert map}).
  ...
  partially by mail, making comparative, county-level case studies
  particularly alluring, if\ldots{}
  
  \section{The Data}\label{the-data}
  
  \ldots{}there is access to significant amounts of data that give a
  complete overview of voting during that time period.
