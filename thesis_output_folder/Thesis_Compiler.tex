...
% Everything below added by CII
  ...
  \item
    ...
    (Matsusaka \& Palda, 1999). Burden (2013) also demonstrates support
    for Aldrich's thesis by using data from Wisconsin to calculate a net
    negative effect of 2\% on turnout due to a similar slight shift in
    turnout.(Aldrich, 1993; Burden, Canon, Mayer, \& Moynihan, 2014)
  \item
