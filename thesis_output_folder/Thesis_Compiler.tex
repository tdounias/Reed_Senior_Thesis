...
% Everything below added by CII
  ...
  section should serve as a general introduction to the methods.
  
  \subsection{Multiple Regression -- Ordinary Least
  Squares}\label{multiple-regression-ordinary-least-squares}
  ...
  multiplying p by the exponent of the corresponding coefficient.
  ...
  \[Y_i = \alpha_{[i], j} + X_iB\]\\
  \[\alpha_{[i], j} \sim N(U_{j[i]}\Gamma, \sigma_{\alpha}^2)\]\\
  \emph{Maybe include varying slopes? Why/why not?}
