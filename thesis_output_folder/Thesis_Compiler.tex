...
% Everything below added by CII
  ...
  \item
    ...
    either be habitual voters, or habitual non-voters ({\textbf{???}}) by
  ...
  places, which can service multiple counties ({\textbf{???}}). I include
  this paper here due to the link that voting centers have with VBM, as
  they serve as drop-off points for mail-in ballots. Richey (2008)
  ...
  Southern regions, as shown on the following map. (Bureau, n.d.)
  
  \begin{figure}
  
  {\centering \includegraphics[width=0.4\linewidth]{/Users/tdounias/Desktop/Reed_Senior_Thesis/maps/pct_white_county_map} 
  ...
  {\centering \includegraphics[width=0.4\linewidth]{/Users/tdounias/Desktop/Reed_Senior_Thesis/maps/pct_registered_county_map} 
  ...
  {\centering \includegraphics[width=0.4\linewidth]{/Users/tdounias/Desktop/Reed_Senior_Thesis/maps/party_affiliation_county_map} 
  ...
  \hypertarget{ref-census_data_2010}{}
  Bureau, U. C. (n.d.). U.S. Census Bureau QuickFacts: Colorado. Retrieved
