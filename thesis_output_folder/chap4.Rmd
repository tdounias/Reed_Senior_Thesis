...
```{r time splines, echo=FALSE, fig.cap="Model 4 Turnout Coefficient for Time Over Spline Knots", out.width = '80%', fig.align='center'}
knitr::include_graphics("/Users/tdounias/Desktop/Reed_Senior_Thesis/plots/spline_plot.png")
```
