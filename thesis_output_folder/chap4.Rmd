...
The models are extremely RAM intensive; particularly the individual level models, for which I have almost 35 million different observations, do not run. For now, I compensated for this problem by using stratified sampling to sample a subset of my observations^[A long term solution to this issue could be the use of a virtual machine, or some RStudio server, Or Amazon Work Spaces (AWS).].
