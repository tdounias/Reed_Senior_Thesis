...
index <- data.frame(c("Ballot", "Individual", "County", "Election", "Local Result", "General Index"), 
                    c("u", "z", "x", "w", "v", "--"), 
                    c("i", "j", "k", "l", "k,l", "i'"))
